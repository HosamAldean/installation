    ...
    return (
        <div ref={ref} className="relative inline-block text-left">
            ...
            >
                ...
                <i className={`i-mingcute-down-line w-4 h-4 transition-transform ${open ? 'rotate-180' : ''}`} />
            </button>
            ...
            {open && (
                ...
                >
                    ...
                    <div className="flex flex-col gap-2">
                        <Button onClick={() => navigate('/profile')} variant="ghost" className="justify-start">
                            {strings.profile}
                        </Button>
                        <Button onClick={() => navigate('/settings')} variant="ghost" className="justify-start">
                            {strings.settings}
                        </Button>
