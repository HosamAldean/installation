...
const API_URL =
    import.meta.env.VITE_API_URL?.replace(/\/$/, "") || "http://192.168.20.157:4000";
...
export default function Login() {
    ...
    return (
        ...
        ${language === "ar" ? "font-[Cairo] direction-rtl" : "font-sans direction-ltr"}
        ...
        >
            ...
            >
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-3xl font-bold text-gray-800">{strings.welcome}</h2>
                    <button
                        type="button"
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className={`w-full py-2.5 rounded-lg text-white font-semibold shadow-md ${loading
